        ...
        <div className="callback-card">
          <div className="callback-loading">
            ...
            <div className="loading-steps">
              <div className="step">1. Validating authorization code</div>
              <div className="step">2. Exchanging for tokens</div>
              <div className="step">3. Loading user profile</div>
              <div className="step">4. Redirecting to dashboard</div>
            </div>
          </div>
        </div>
      </div>
